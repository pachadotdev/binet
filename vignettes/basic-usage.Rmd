...
This example is inspired after the visualizations from @global2014.
...
net$network_source %>%
  ...
  geom_node_point(color = "darkslategray4", size = 8) +
  geom_node_text(aes(label = name), vjust = 2.2) +
  ggtitle("Original Language Projection") +
  theme_void()
```
...
net$network_target %>%
  ...
  geom_node_point(color = "darkslategray4", size = 4) +
  geom_node_text(aes(label = name), vjust = 2.2) +
  ggtitle("Translated Language Projection") +
  theme_void()
```
